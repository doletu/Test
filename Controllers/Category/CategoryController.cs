...
namespace MVC.Controllers.Category
{
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            listcategory.Insert(0, new Models.Category()
            {
        ...
        async Task<IEnumerable<Models.Category>> GetItemsSelectCategorie()
        {
            ...
            List<Models.Category> resultitems = new List<Models.Category>() {
                new Models.Category() {
                    Id = -1,
                    Title = "Không có danh mục cha"
                }
            };
            Action<List<Models.Category>, int> _ChangeTitleCategory = null;
            Action<List<Models.Category>, int> ChangeTitleCategory = (items, level) => {
        ...
        public async Task<IActionResult> Create([Bind("Id,ParentId,Title,Content,Slug")] Models.Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ParentId,Title,Content,Slug")] Models.Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
